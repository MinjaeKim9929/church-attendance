	...
	useEffect(() => {
		...
		const sorted = [...filtered].sort((a, b) => {
			...
			if (sortBy === 'grade') {
				...
				// Sort by name day month (1-12), empty values go to end
				const monthA = a.nameDayMonth ? parseInt(a.nameDayMonth) : 999;
				const monthB = b.nameDayMonth ? parseInt(b.nameDayMonth) : 999;
						...
						<>
							...
							<div className="md:hidden mb-4">
								...
								>
									...
									<option value="nameDay">축일순</option>
								</select>
							</div>
													...
													{filteredStudents.map((student) => (
														...
														>
															<td className="px-6 py-3.5 whitespace-nowrap">
																<div className="text-sm text-gray-500">{student.permanentNumber}</div>
															</td>
															<td className="px-6 py-3.5 whitespace-nowrap">
