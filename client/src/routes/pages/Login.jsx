						...
						<div>
							...
							<div className="relative">
								...
								<button
									...
									disabled={authLoading}
									className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors p-1 disabled:opacity-50 hover:cursor-pointer"
